  ...
  <div class="auth-box">
    ...
    <form method="post" action="<?= BASE_URL ?>index.php?controller=auth&action=handleLogin">
      ...
      <div class="auth-links">
        <a href="<?= BASE_URL ?>index.php?controller=auth&action=forgotPassword" class="forgot-link">
          Quên mật khẩu?
        </a>
      </div>
      ...
      <p class="auth-switch">
        Chưa có tài khoản?
        <a href="<?= BASE_URL ?>index.php?controller=auth&action=register">Đăng ký ngay</a>
      </p>
    </form>
  </div>
</div>
